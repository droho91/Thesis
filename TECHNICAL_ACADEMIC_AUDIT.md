...
| Service tests | 227/227 pass | Phase 9 bổ sung regression cho live-client proof coverage/digest/gateway binding, summary/integration schema, browser/defense preflight, Git provenance environment, clean hosted-evidence workflow và bounded Docker Desktop WSL cwd retry trên nền Phase 8 |
