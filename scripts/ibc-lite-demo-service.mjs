...
function operationLabel(action) {
  const labels = {
    ...
    finalizeForwardHeader: "Finalize forward header",
    updateForwardClient: "Update forward client",
    ...
    burn: "Burn voucher",
    finalizeReverseHeader: "Finalize reverse header",
    updateReverseClient: "Update reverse client",
