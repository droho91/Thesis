...
/// @title IBCPacketLibV2
/// @notice Deterministic v2 packet envelope with explicit channel and timeout fields.
library IBCPacketLibV2 {
    uint8 internal constant ACTION_LOCK_MINT = 1;
    uint8 internal constant ACTION_BURN_UNLOCK = 2;

    bytes32 internal constant PACKET_TYPEHASH = keccak256("IBCLite.Packet.v2");
    bytes32 internal constant PACKET_LEAF_TYPEHASH = keccak256("IBCLite.PacketLeaf.v2");
    bytes32 internal constant PACKET_COMMITMENT_PATH_TYPEHASH = keccak256("IBCLite.PacketCommitmentPath.v2");
