...
/// @title IBCConnectionKeeper
/// @notice Minimal connection state keeper for the interchain lane.
/// @dev The proof-checked handshake stores compact commitments instead of proving Solidity struct layout directly.
contract IBCConnectionKeeper is AccessControl, IBCEVMProofBoundary {
    bytes32 public constant CONNECTION_ADMIN_ROLE = keccak256("CONNECTION_ADMIN_ROLE");
    bytes32 public constant CONNECTION_COMMITMENT_TYPEHASH = keccak256("IBC.ConnectionEnd");
    ...
    constructor(uint256 _localChainId, address besuLightClient_, address admin) IBCEVMProofBoundary(besuLightClient_) {
